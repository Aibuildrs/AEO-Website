...
export default function ChoiceComparison() {
  return (
    <div className="min-h-screen p-8">
      ...
      <h1 className="text-5xl text-center md:text-5xl font-bold mb-8 mt-8 leading-tight">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 rounded-2xl p-8 border border-green-100 shadow-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p>
                Learn how to position yourself as the authority in your category.
              </p>
              
              <p className="font-medium">
                Be first in line when beta spots open. In 12 months, you'll be 
                the one getting cited. The one competitors are trying to catch. 
        ...
        <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
          ...
          <div className="space-y-4 text-gray-700 text-lg">
            ...
            <p>
              ...
              hit 3.7 billion monthly visits. Perplexity grew 300% year-over-year. 
              Google is showing AI Overviews on 84% of results.
            </p>
